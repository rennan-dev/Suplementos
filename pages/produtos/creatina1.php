    ...
    <div class="row g-0 text-center">
        <div class="col-6 col-md-4">
            ...
            <div class="card h-100 shadow custom-card">
                ...
                <img src="../../Imagens/ProdutosSemFundo/creatina_integralmedica-removebg-preview.png" alt="" class="card-img-top w-100 custom-bg">
                <div class="card-body">
                  <h4 id="product1" class="card-title">Creatina 300g Integralmédica</h4>
            ...
            <div class="accordion accordion-flush mt-3" id="accordionFlushExample">
                <div class="accordion-item">
                  ...
                  <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">A CREATINA HARDCORE da INTEGRALMÉDICA é um composto derivado de aminoácidos. Uma vez dentro das células, é convertida em fosfocreatina e utilizada como reserva de energia, principalmente nas células do músculo esquelético. Incluímos a CREATINA na dieta, com o objetivo de melhorar a performance e aumentar a massa muscular. Quando utiliza-se a CREATINA, a célula muscular é hiper hidratada, assim aumenta seu tamanho, ganha volume. As células musculares funcionam como balões de água (músculos são 70% água), que quando cheios se tornam maiores e mais firmes. Se vazios, sem água, se tornam menores. Estimulados pelo treinamento com pesos, estes músculos cheios de CREATINA e água, começam a inchar bombeados com mais sangue e volumização.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">Maior desempenho nas atividades de força e potência muscular; - Maior sobrecarga muscular; - Aumento do volume das células musculares; - Recuperação mais rápida pós-treino;</div>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Diluir a porção de (1 dosador conforme graduação) CREATINA HARDCORE Reload Integral Médica em bebida de sua preferência e consumir antes do treino, ou conforme orientação profissional.</div>
                </div>
              </div>
              <div class="accordion-item">
                <h2 class="accordion-header">
                ...
                <div id="flush-collapseFor" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Ingerir pelo menos 8 copos de água diariamente; O consumo de carboidratos com CREATINA pode melhorar sua absorção e eficácia.</div>
                </div>
              </div>
              <div class="accordion-item">
                <h2 class="accordion-header">
                ...
                <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">CREATINA mono-hidratada. NÃO CONTÉM GLÚTEN.</div>
                </div>
              </div>
            </div>
        </div>
